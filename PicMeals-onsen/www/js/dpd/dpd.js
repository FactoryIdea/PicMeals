...
dpd.comments = dpd("/comments");
dpd.comments.on = function(ev, fn) {
  return dpd.on("comments" + ":" + ev, fn);
}
dpd.comments.once = function(ev, fn) {
  return dpd.once("comments" + ":" + ev, fn);
}
dpd.comments.off = function(ev, fn) {
  return dpd.off("comments" + ":" + ev, fn);
}
dpd.comments.rename = function (path, body, fn) {
  dpd.comments.exec("rename", path, body, fn);
}

dpd.cuisine = dpd("/cuisine");
dpd.cuisine.on = function(ev, fn) {
  return dpd.on("cuisine" + ":" + ev, fn);
}
dpd.cuisine.once = function(ev, fn) {
  return dpd.once("cuisine" + ":" + ev, fn);
}
dpd.cuisine.off = function(ev, fn) {
  return dpd.off("cuisine" + ":" + ev, fn);
}
dpd.cuisine.rename = function (path, body, fn) {
  dpd.cuisine.exec("rename", path, body, fn);
}

dpd.email = dpd("/email");
dpd.email.on = function(ev, fn) {
  return dpd.on("email" + ":" + ev, fn);
}
dpd.email.once = function(ev, fn) {
  return dpd.once("email" + ":" + ev, fn);
}
dpd.email.off = function(ev, fn) {
  return dpd.off("email" + ":" + ev, fn);
}

dpd.events = dpd("/events");
dpd.events.on = function(ev, fn) {
  return dpd.on("events" + ":" + ev, fn);
}
dpd.events.once = function(ev, fn) {
  return dpd.once("events" + ":" + ev, fn);
}
dpd.events.off = function(ev, fn) {
  return dpd.off("events" + ":" + ev, fn);
}
dpd.events.rename = function (path, body, fn) {
  dpd.events.exec("rename", path, body, fn);
}

dpd.fileupload = dpd("/fileupload");
dpd.fileupload.on = function(ev, fn) {
  return dpd.on("fileupload" + ":" + ev, fn);
}
dpd.fileupload.once = function(ev, fn) {
  return dpd.once("fileupload" + ":" + ev, fn);
}
dpd.fileupload.off = function(ev, fn) {
  return dpd.off("fileupload" + ":" + ev, fn);
}

dpd.followers = dpd("/followers");
dpd.followers.on = function(ev, fn) {
  return dpd.on("followers" + ":" + ev, fn);
}
dpd.followers.once = function(ev, fn) {
  return dpd.once("followers" + ":" + ev, fn);
}
dpd.followers.off = function(ev, fn) {
  return dpd.off("followers" + ":" + ev, fn);
}
dpd.followers.rename = function (path, body, fn) {
  dpd.followers.exec("rename", path, body, fn);
}

dpd.hellojs = dpd("/hellojs");
dpd.hellojs.on = function(ev, fn) {
  return dpd.on("hellojs" + ":" + ev, fn);
}
dpd.hellojs.once = function(ev, fn) {
  return dpd.once("hellojs" + ":" + ev, fn);
}
dpd.hellojs.off = function(ev, fn) {
  return dpd.off("hellojs" + ":" + ev, fn);
}
dpd.hellojs.rename = function (path, body, fn) {
  dpd.hellojs.exec("rename", path, body, fn);
}

dpd.invites = dpd("/invites");
dpd.invites.on = function(ev, fn) {
  return dpd.on("invites" + ":" + ev, fn);
}
dpd.invites.once = function(ev, fn) {
  return dpd.once("invites" + ":" + ev, fn);
}
dpd.invites.off = function(ev, fn) {
  return dpd.off("invites" + ":" + ev, fn);
}
dpd.invites.rename = function (path, body, fn) {
  dpd.invites.exec("rename", path, body, fn);
}

dpd.likes = dpd("/likes");
dpd.likes.on = function(ev, fn) {
  return dpd.on("likes" + ":" + ev, fn);
}
dpd.likes.once = function(ev, fn) {
  return dpd.once("likes" + ":" + ev, fn);
}
dpd.likes.off = function(ev, fn) {
  return dpd.off("likes" + ":" + ev, fn);
}
dpd.likes.rename = function (path, body, fn) {
  dpd.likes.exec("rename", path, body, fn);
}

dpd.meals = dpd("/meals");
dpd.meals.on = function(ev, fn) {
  return dpd.on("meals" + ":" + ev, fn);
}
dpd.meals.once = function(ev, fn) {
  return dpd.once("meals" + ":" + ev, fn);
}
dpd.meals.off = function(ev, fn) {
  return dpd.off("meals" + ":" + ev, fn);
}
dpd.meals.rename = function (path, body, fn) {
  dpd.meals.exec("rename", path, body, fn);
}
...
dpd.offers = dpd("/offers");
dpd.offers.on = function(ev, fn) {
  return dpd.on("offers" + ":" + ev, fn);
}
dpd.offers.once = function(ev, fn) {
  return dpd.once("offers" + ":" + ev, fn);
}
dpd.offers.off = function(ev, fn) {
  return dpd.off("offers" + ":" + ev, fn);
}
dpd.offers.rename = function (path, body, fn) {
  dpd.offers.exec("rename", path, body, fn);
}

dpd.paypal = dpd("/paypal");
dpd.paypal.on = function(ev, fn) {
  return dpd.on("paypal" + ":" + ev, fn);
}
dpd.paypal.once = function(ev, fn) {
  return dpd.once("paypal" + ":" + ev, fn);
}
dpd.paypal.off = function(ev, fn) {
  return dpd.off("paypal" + ":" + ev, fn);
}

dpd.places = dpd("/places");
dpd.places.on = function(ev, fn) {
  return dpd.on("places" + ":" + ev, fn);
}
dpd.places.once = function(ev, fn) {
  return dpd.once("places" + ":" + ev, fn);
}
dpd.places.off = function(ev, fn) {
  return dpd.off("places" + ":" + ev, fn);
}
dpd.places.rename = function (path, body, fn) {
  dpd.places.exec("rename", path, body, fn);
}

dpd.tags = dpd("/tags");
dpd.tags.on = function(ev, fn) {
  return dpd.on("tags" + ":" + ev, fn);
}
dpd.tags.once = function(ev, fn) {
  return dpd.once("tags" + ":" + ev, fn);
}
dpd.tags.off = function(ev, fn) {
  return dpd.off("tags" + ":" + ev, fn);
}
dpd.tags.rename = function (path, body, fn) {
  dpd.tags.exec("rename", path, body, fn);
}
...
dpd.transactions = dpd("/transactions");
dpd.transactions.on = function(ev, fn) {
  return dpd.on("transactions" + ":" + ev, fn);
}
dpd.transactions.once = function(ev, fn) {
  return dpd.once("transactions" + ":" + ev, fn);
}
dpd.transactions.off = function(ev, fn) {
  return dpd.off("transactions" + ":" + ev, fn);
}
dpd.transactions.rename = function (path, body, fn) {
  dpd.transactions.exec("rename", path, body, fn);
}

dpd.userdietintollerance = dpd("/user-diet-intollerance");
dpd.userdietintollerance.on = function(ev, fn) {
  return dpd.on("user-diet-intollerance" + ":" + ev, fn);
}
dpd.userdietintollerance.once = function(ev, fn) {
  return dpd.once("user-diet-intollerance" + ":" + ev, fn);
}
dpd.userdietintollerance.off = function(ev, fn) {
  return dpd.off("user-diet-intollerance" + ":" + ev, fn);
}
dpd.userdietintollerance.rename = function (path, body, fn) {
  dpd.userdietintollerance.exec("rename", path, body, fn);
}

dpd.userdietrestrictions = dpd("/user-diet-restrictions");
dpd.userdietrestrictions.on = function(ev, fn) {
  return dpd.on("user-diet-restrictions" + ":" + ev, fn);
}
dpd.userdietrestrictions.once = function(ev, fn) {
  return dpd.once("user-diet-restrictions" + ":" + ev, fn);
}
dpd.userdietrestrictions.off = function(ev, fn) {
  return dpd.off("user-diet-restrictions" + ":" + ev, fn);
}
dpd.userdietrestrictions.rename = function (path, body, fn) {
  dpd.userdietrestrictions.exec("rename", path, body, fn);
}
